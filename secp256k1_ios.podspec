...
s.exclude_files = 'secp256k1_ios/src/test*.{c,h}', 'secp256k1_ios/src/gen_context.c', 'secp256k1_ios/src/*bench*.{c,h}', 'secp256k1_ios/src/*bench*.{c,h}', 'secp256k1_ios/src/modules/{recovery,ecdh}/*test*.{c,h}', 'secp256k1_ios/src/ctime_tests.c'
end
